...
Version:        1.0.16
Release:        %autorelease
Summary:        A vruntime-based sched_ext scheduler that prioritizes interactive workloads. https://github.com/sched-ext/scx/tree/main
...
which is a Linux kernel feature which enables implementing kernel
thread schedulers in BPF and dynamically loading them.
