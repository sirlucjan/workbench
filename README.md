...
* [bfq-dev-rc](https://github.com/sirlucjan/kernel-patches/tree/master/5.6-rc/bfq-dev-lucjan-sep) / [bfq-dev-rc](https://gitlab.com/sirlucjan/kernel-patches/tree/master/5.6-rc/bfq-dev-lucjan-sep) - specific patches authored by Paolo Valente and Piotr Gorski

* [LL-patches](https://github.com/sirlucjan/kernel-patches/tree/master/5.6-rc/ll-patches) / [LL-patches](https://gitlab.com/sirlucjan/kernel-patches/tree/master/5.6-rc/ll-patches) - specific patches authored by Piotr Gorski
...
* [bfq-reverts](https://github.com/sirlucjan/kernel-patches/tree/master/5.6-rc/bfq-reverts-all-v2) / [bfq-reverts](https://gitlab.com/sirlucjan/kernel-patches/tree/master/5.6-rc/bfq-reverts-all-v2) - specific patches authored by Piotr Gorski
